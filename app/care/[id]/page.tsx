...
import { CARE_CENTERS, BRANCH_META, isF2REligible } from "@/data/care-centers";
    ...
    <main className="min-h-screen bg-gray-50 pb-24">
      ...
      <section className="px-5 py-6 text-white" style={{ backgroundColor: "#0E7490" }}>
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            {f2r && (
              <span
                className="inline-block text-[11px] px-2 py-0.5 rounded font-bold"
                style={{ color: "#CA8A04", backgroundColor: "#FEF9C3" }}
              >
                🌏 {t("careF2RBadge")}
              </span>
            )}
      ...
      <div className="max-w-3xl mx-auto px-5 pt-5 space-y-3">
        ...
        {f2r && (
          ...
          >
            <div className="text-[12px] font-bold mb-1" style={{ color: "#CA8A04" }}>
              🌏 {t("careF2RBadge")}
            </div>
            <div className="text-[11px] leading-relaxed" style={{ color: "#78350F" }}>
              {t("careF2RNotice")}
            </div>
          </div>
        )}
