...
export const TEXTS = {
  ...
  catPlaceDesc: {
    ko: "학생들이 추천하는 맛집·카페·명소",
    en: "Student-recommended spots",
    vi: "Địa điểm sinh viên giới thiệu",
    uz: "Talabalar tavsiyalari",
  },
  subPlaceBoard: {
    ko: "장소 둘러보기",
    en: "Browse places",
    vi: "Khám phá địa điểm",
    uz: "Joylarni koʻrish",
  },
  subPlaceRegister: {
    ko: "장소 추천하기",
    ...
    uz: "Joy tavsiya qilish",
  },
  placeHeroTitle: {
    ko: "학생 장소 추천 커뮤니티",
    en: "Student Place Picks",
    vi: "Cộng đồng giới thiệu địa điểm",
    uz: "Talabalar joy tavsiyalari",
  },
  placeHeroDesc: {
    ko: "맛집·카페·공부 장소 등 학생들이 직접 추천하는 공간",
    en: "Food, cafes, study spots & more — picked by students",
    vi: "Quán ăn, cà phê, chỗ học … do sinh viên giới thiệu",
    uz: "Ovqat, kafe, oʻquv joylari va boshqalar — talabalar tanlagan",
  },
  placeCatFood: {
    ko: "🍽️ 음식점",
    en: "🍽️ Restaurant",
  ...
  fieldPlaceTags: {
    ko: "특징 태그 (복수 선택 가능)",
    en: "Tags (multiple allowed)",
    vi: "Thẻ đặc điểm (chọn nhiều)",
    uz: "Teglar (bir nechtasini tanlash mumkin)",
  },
  fieldPlaceAddress: {
    ko: "주소 또는 위치 설명",
    en: "Address or location",
    vi: "Địa chỉ hoặc mô tả vị trí",
    uz: "Manzil yoki joy tavsifi",
  },
  fieldPlaceReason: {
    ko: "추천 이유 *",
    en: "Why recommend? *",
    vi: "Lý do giới thiệu *",
    uz: "Nima uchun tavsiya qilasiz? *",
  },
  placeSubmitBtn: {
    ko: "추천 등록하기",
    en: "Submit Recommendation",
    vi: "Gửi giới thiệu",
    uz: "Tavsiyani yuborish",
  },
  placeBannerShort: {
    ko: "🗺️ 학생이 직접 발견한 좋은 장소를 공유해보세요! 부적절한 내용은 AI가 자동 필터링합니다.",
    en: "🗺️ Share your favourite spots with fellow students! Inappropriate content is auto-filtered by AI.",
    vi: "🗺️ Chia sẻ địa điểm yêu thích của bạn! Nội dung không phù hợp sẽ bị AI lọc tự động.",
    uz: "🗺️ Sevimli joylaringizni ulashing! Noto'g'ri kontent AI tomonidan avtomatik filtrlanadi.",
  },
  placeReasonPlaceholder: {
    ko: "이 장소를 추천하는 이유를 써주세요 (예: 할랄 메뉴가 있어요, 조용해서 공부하기 좋아요)",
    en: "Why do you recommend this place? (e.g., has halal menu, great for studying)",
    vi: "Tại sao bạn giới thiệu nơi này? (vd: có thực đơn halal, yên tĩnh để học)",
    uz: "Nima uchun bu joyni tavsiya qilasiz? (masalan: halol menyu bor, oʻqish uchun qulay)",
  },
  placeFilterAll: {
    ko: "전체",
    en: "All",
  ...
  placeNoItems: {
    ko: "아직 추천된 장소가 없습니다. 첫 번째로 추천해보세요!",
    en: "No places yet. Be the first to recommend one!",
    vi: "Chưa có địa điểm nào. Hãy là người đầu tiên giới thiệu!",
    uz: "Hali joy yoʻq. Birinchi boʻlib tavsiya qiling!",
  },
  placeRecommendBtn: {
    ko: "＋ 장소 추천하기",
    en: "＋ Recommend a Place",
  ...
  placeAiSummaryDesc: {
    ko: "추천 이유 5개 이상이 쌓이면 AI가 이 장소의 특징을 자동 요약합니다",
    en: "AI auto-summarises this place once 5+ recommendations accumulate",
    vi: "AI tự tóm tắt khi có 5+ lý do giới thiệu",
    uz: "5+ tavsiya toʻplanganda AI avtomatik xulosalaydi",
  },
  placePostedBy: {
    ko: "추천자",
    en: "Recommended by",
  ...
  placeContentBlocked: {
    ko: "⚠️ 이 내용은 커뮤니티 가이드라인에 맞지 않아 등록할 수 없습니다.",
    en: "⚠️ This content violates community guidelines and cannot be posted.",
    vi: "⚠️ Nội dung này vi phạm quy tắc cộng đồng và không thể đăng.",
    uz: "⚠️ Bu kontent hamjamiyat qoidalariga zid va joylashtirilmaydi.",
  },
